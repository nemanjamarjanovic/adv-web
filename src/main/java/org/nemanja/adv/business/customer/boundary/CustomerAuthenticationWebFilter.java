...
//@WebFilter(urlPatterns = "/rest/customers/*")
public class CustomerAuthenticationWebFilter implements Filter
{

    @Inject
    private TokenService tokenService;

    private final static Logger logger = Logger.getLogger(CustomerAuthenticationWebFilter.class.getName());
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException
    {
        ...
        {
            // security check
            if (!tokenService.getToken(authToken).getAdvUser().getAdvRole().isCustomer())
            {
